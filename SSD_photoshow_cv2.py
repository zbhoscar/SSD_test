...
l=where+'examples/images/fish-bike.jpg'
#image = caffe.io.load_image(l)
...
colors=[[255,0,0],[255,255,0],[173,255,47],[127,255,212],[0,0,205],[125,38,205],[238,203,173],[139,131,134]]
...
for i in xrange(top_conf.shape[0]):
    ...
    print i,label_name,xmin,ymin,xmax,ymax,score,label,display_txt, color
